package com.mihai.recipeapp.bootstrap;

import com.mihai.recipeapp.domain.*;
import com.mihai.recipeapp.repositories.CategoryRepository;
import com.mihai.recipeapp.repositories.RecipeRepository;
import com.mihai.recipeapp.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.addIngredient(new Ingredient("fresh lime juice or leomn juice", new BigDecimal(2), tableSpoonUom));
        guacRecipe.addIngredient(new Ingredient("minced red onion or thinly sliced green onion", new BigDecimal(2), tableSpoonUom));
        guacRecipe.addIngredient(new Ingredient("serrano chiles, stems and seeds removed, minced", new BigDecimal(2), eachUom));
        guacRecipe.addIngredient(new Ingredient("Chilantro", new BigDecimal(2), dashUom));
